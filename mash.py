...
#         '''
        html = '''
           ...
           <td style="width: 27.45px; text-align: center;"><a href="/right"><img style="border: 0px solid ; width: 50px; height: 50px;" src="http://192.168.240.14/potato/mages/right.png" alt=""></a></td>
           </tr>
