...
<td style="text-align: center;"></td>
</tr><tr><td style="text-align: center;"></td><td style="text-align: center;"></td><td style="text-align: center;"></td></tr><tr><td style="height: 50px; width: 50px; text-align: center; vertical-align: middle;"></td><td style="height: 50px; width: 50px; text-align: center;"><a href="/camup"><img style="border: 0px solid ; width: 50px; height: 50px;" alt="" src="http://192.168.240.14/potato/images/forward.png"></a></td><td style="height: 50px; width: 50px; text-align: center;"></td></tr><tr><td style="height: 50px; width: 50px; text-align: center;"><a href="/camleft"><img style="border: 0px solid ; width: 50px; height: 50px;" src="http://192.168.240.14/potato/images/left.png" alt="" hspace="0" vspace="0"></a></td><td style="text-align: center;"><a href="/camstop"><img style="border: 0px solid ; width: 50px; height: 50px;" src="http://192.168.240.14/potato/images/stop.png" alt=""></a></td><td style="text-align: center;"><a href="/camright"><img style="border: 0px solid ; width: 50px; height: 50px;" src="http://192.168.240.14/potato/images/right.png" alt=""></a></td></tr><tr><td style="text-align: center;"></td><td style="text-align: center;"><a href="/camdown"><img style="border: 0px solid ; width: 50px; height: 50px;" alt="" src="http://192.168.240.14/potato/images/back.png"></a></td><td style="text-align: center;"></td></tr>
</tbody>
</table>
        <script>
